...
public class PGPEncryptionUtil {
  ...
  private static PGPLiteralData asLiteral(final byte[] message, final InputStream secretKeyRing,
    ...
    for (final Iterator<PGPPublicKeyEncryptedData> i = (Iterator<PGPPublicKeyEncryptedData>) getEncryptedObjects(message);
         (key == null) && i.hasNext(); ) {
      encrypted = i.next();
  ...
  private static Iterator<? extends PGPEncryptedData> getEncryptedObjects(final byte[] message) throws IOException {
    try {
      ...
      return (Iterator<? extends PGPEncryptedData>) ((PGPEncryptedDataList) list).getEncryptedDataObjects();
    } catch (IOException e) {
  ...
  public static ContentAndSignatures decryptAndReturnSignatures(final byte[] encryptedMessage,
    ...
    try {
      ...
      final PGPSecretKeyRingCollection keys = new PGPSecretKeyRingCollection(
              ...
              new JcaKeyFingerprintCalculator());
      PGPPublicKeyEncryptedData encrypted = null;
      for (final Iterator<PGPPublicKeyEncryptedData> i = (Iterator<PGPPublicKeyEncryptedData>) getEncryptedObjects(encryptedMessage);
           (key == null) && i.hasNext(); ) {
        encrypted = i.next();
        key = getPrivateKey(keys, encrypted.getKeyID(), secretPwd);
      }
  ...
  public static byte[] decryptAndVerify(byte[] encryptedMessage, final PGPSecretKey secretKey,
    ...
    try {
      Iterator<PGPPublicKeyEncryptedData> it = (Iterator<PGPPublicKeyEncryptedData>) getEncryptedObjects(encryptedMessage);
      PGPPrivateKey sKey;
